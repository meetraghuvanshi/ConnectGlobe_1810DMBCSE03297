					...
					<div align="left">
						<table width="900" border="1" align="left"
							...
							<tr>
								...
								<td bgcolor="33CCCC"><div align="center" class="style2">Taluka</div></td>
							...
							<c:forEach items="${pageScope.result.rows}" var="row">
								<tr>
									<td><center><c:out value="${row.post_id}" /></center></td>
									<td><center><c:out value="${row.state}" /></center></td>
									<td><center><c:out value="${row.district}" /></center></td>
									<td><center><c:out value="${row.taluka}" /></center></td>
									<td><center><c:out value="${row.your_report}" /></center></td>
									<td><center><c:out value="${row.Your_status}" /></center></td>
									<td><center><c:out value="${row.picture}" /></center></td>
									<td><center><a href="RemovePost.jsp?post_id=<c:out value="${row.post_id}"/>">
											Delete</a></center></td>
								</tr>
							</c:forEach>
						</table>
